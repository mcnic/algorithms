...
class TestLinkedList(unittest.TestCase):
    ...
    def test_add_in_tail(self):
        ...
        self.assertEqual(list3.get_head().prev, None)
        self.assertEqual(list3.get_tail().next, None)
        self.assertEqual(list3.get_head().next, n2)
        self.assertEqual(list3.get_tail().prev, n2)
    ...
    def test_insert_in_tail(self):
        list3 = LinkedList2().create_list([20, 55, 12, 10, 55])
        n6 = Node(22)
    ...
    def test_insert_to_empty(self):
        ...
        self.assertEqual(list3.get_head().prev, None)
        self.assertEqual(list3.get_tail().next, None)
        self.assertEqual(n7.next, None)
        self.assertEqual(n7.prev, None)
